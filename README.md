...
> [!IMPORTANT]
> When using C3 to create this project, select "no" when it asks if you want to deploy. You need to follow this project's [setup steps](https://github.com/cloudflare/templates/tree/main/odd-flower-b39b#setup-steps) before deploying.
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/odd-flower-b39b
```

A live public deployment of this template is available at [https://odd-flower-b39b.templates.workers.dev](https://odd-flower-b39b.templates.workers.dev)
